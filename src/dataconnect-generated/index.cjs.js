...
exports.deleteUserData = function deleteUserData(dc) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dc, undefined);
...
const createTaskTagRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.createTaskTag = function createTaskTag(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(createTaskTagRef(dcInstance, inputVars));
}
;

const deleteTaskTagRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.deleteTaskTag = function deleteTaskTag(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(deleteTaskTagRef(dcInstance, inputVars));
}
;

const getTaskTagRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetTaskTag', inputVars);
}
getTaskTagRef.operationName = 'GetTaskTag';
exports.getTaskTagRef = getTaskTagRef;

exports.getTaskTag = function getTaskTag(dcOrVars, varsOrOptions, options) {
...
exports.listTaskTags = function listTaskTags(dcOrOptions, options) {
